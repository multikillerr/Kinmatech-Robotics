...
class Robot(object):
    ...
    def __init__(self, params, initial_offset, plot_xlim=[-0.5, 0.5], plot_ylim=[-0.5, 0.5], plot_zlim=[0.0, 1.0],
        ...
        # plot attributes kept for API compatibility; no matplotlib backend
    ...
    # ================== plot related
    # ================== plot related (display stubs – matplotlib removed)
    # ==================
    ...
    def show(self, body=True, ws=False):
        print("Robot.show() is disabled – matplotlib has been removed. "
              "Use the PyQtGraph visualiser in ui/main.py instead.")
